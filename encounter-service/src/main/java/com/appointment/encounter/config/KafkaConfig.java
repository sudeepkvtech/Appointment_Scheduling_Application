package com.appointment.encounter.config;
...
/**
 * Kafka configuration for consuming appointment events
 */
@Configuration
public class KafkaConfig {
    ...
    public ConsumerFactory<String, AppointmentEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(config,
            ...
            new ErrorHandlingDeserializer<>(new JsonDeserializer<>(AppointmentEvent.class, false)));
    }
